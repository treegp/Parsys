...
namespace Parsys.WinClient.Views.EntityManagerForms.ProductCategories
{
    ...
    public partial class List : ViewBaseControl
    {
        ...
        public List()
        {
            ...
            grid = new GridHandler<DataLayer.Entities.EntityModels.ProductCategories>(this, repo.GetByIsDeleted(false));
            ...
            AddButtun("جدید", b =>
            {
                ...
                {
                    nw.Entity = new DataLayer.Entities.EntityModels.ProductCategories();
                    nw.Title = "تعریف دسته بندی جدید";
                }, true);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            grid.AddStringColumn(i => i.InventoryId, "انبار");
            grid.AddStringColumn(i => i.ParentCategoryId, "دسته بندی والد");
