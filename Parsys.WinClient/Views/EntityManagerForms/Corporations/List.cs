...
namespace Parsys.WinClient.Views.EntityManagerForms.Corporations
{
    ...
    public partial class List : ViewBaseControl
    {
        ...
        private GridHandler<DataLayer.Entities.EntityModels.Corporations> grid;

        public List()
        {
            InitializeComponent();
            repo = new CorporationsRepository(con.GetConnection());
            grid = new GridHandler<DataLayer.Entities.EntityModels.Corporations>(this, repo.GetByIsDeleted(false));
            ...
            AddButtun("جدید", b =>
            {
                ...
                {
                    nw.Entity = new DataLayer.Entities.EntityModels.Corporations();
